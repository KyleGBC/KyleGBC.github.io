...
<Video
  width='640'
  height='480'
  path='/assets/project-mercury/wallrunning.webm'
/>
Sliding
<Video
  width='640'
  height='480'
  path='/assets/project-mercury/slide.webm'
/>
Crouching and Walking
<Video
  width='640'
  height='480'
  path='/assets/project-mercury/crouch_and_walk.webm'
/>
Mantling and Vaulting
<Video
  width='640'
  height='480'
  path='/assets/project-mercury/mantle_and_vault.webm'
/>
