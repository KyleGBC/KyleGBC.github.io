...
For Fast Food 2: Even Faster, I tried my hand at working on a road-generation system. While that became out of scope for the project, I still worked on a basic traffic and pedestrian system that drove the dynamic cityscape that you drive through in the game.
